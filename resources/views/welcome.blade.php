        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('submit-form')}}" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="description" placeholder="Введите текст заказа">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="checkbox" class="form-check-input" name="plastic1">
                            <label class="form-check-label"  >Пластик1</label>
                        </div>
                        <div class="col-sm-4">
                            <input type="checkbox" class="form-check-input" name="hydozh1">
                            <label class="form-check-label" >Худож</label>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  name="dlina" placeholder="Длина">
                        </div>
                        <div class="col-sm-4">
                            <input type="checkbox" class="form-check-input" name="plastic2">
                            <label class="form-check-label" >Пластик2</label>
                        </div>
                        <div class="col-sm-4">
                            <input type="checkbox" class="form-check-input" name="ing">
                            <label class="form-check-label" >Инженер</label>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <input type="text" class="form-control"  placeholder="Ширина" name="shirina1">
                        </div>
                        <div class="col-sm-4">
                            <input type="checkbox" class="form-check-input" name="plastic3">
